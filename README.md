...
```java
Vite Dev Server / Amplify Hosting
    └── React SPA (React Router)
        ├─ Dashboard page
        ├─ Compliance / Thresholds page 
        ├─ Sites page 
        └─ Ingest Tokens page (Generate API tokens for metrics ingestion)
```
...
## 8. Build & Deploy (Amplify Hosting)
